...
<div class="container mx-auto">
    ...
    <div class="row align-center justify-content-center">
        <div class="col-12">
            ...
            <div class="card card card-outline card-primary" data-bs-theme="dark">
                <div class="card-header">
                                ...
                                @foreach($site->fields as $field)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteFieldModal{{ $field->id }}"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deleteFieldModalLabel{{ $field->id }}">Remover Campo</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Tem certeza de que deseja remover este campo?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                    <form action="{{ route('site_fields.destroy', [$site->id, $field->id]) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                ...
                <div class="card-footer clearfix">
                    <a href="{{ route('site_fields.create', $site->id) }}" class="btn btn-info">Add Campo(s)  <i class="fa fa-plus"></i></a>
                </div>
            </div>
